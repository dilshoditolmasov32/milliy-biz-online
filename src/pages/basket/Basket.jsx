...
console.log(cartItems,"items");
  ...
  const checkedTotal = useMemo(() => {
    return localItems
      ...
      .reduce((sum, item) => {
        const activePrice = item.special_price
  ...
  const oldTotal = useMemo(() => {
    return localItems
      .filter((item) => checkedItems[item.id])
      .reduce((sum, item) => {
        const oldPrice = item.regular_price
            ...
            <div className="basket__total">
              <div className="basket__total-top">
                ...
                <div className="basket__total-desc">
                  {oldTotal > checkedTotal && (
                    <del className="basket__total-desc__old">
                      {formattedOldTotal} {t("value")}
                    </del>
                  )}
